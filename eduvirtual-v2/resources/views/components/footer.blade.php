      ...
      <footer class="bg-yellow dark:bg-gray-800">
        <div class="container px-6 py-4 mx-auto ">
            <div class="lg:flex">
                ...
                <a href="#">
                    <svg class="w-6 h-6 mr-6 text-green-800 fill-current" viewBox="0 0 512 512">
                        <path d="M455.27,32H56.73A24.74,24.74,0,0,0,32,56.73V455.27A24.74,24.74,0,0,0,56.73,480H256V304H202.45V240H256V189c0-57.86,40.13-89.36,91.82-89.36,24.73,0,51.33,1.86,57.51,2.68v60.43H364.15c-28.12,0-33.48,13.3-33.48,32.9V240h67l-8.75,64H330.67V480h124.6A24.74,24.74,0,0,0,480,455.27V56.73A24.74,24.74,0,0,0,455.27,32Z"/>
                    </svg>
                </a>
                <a href="#">
                    <svg fill="none"  class="w-6 h-6 mr-6 text-green-800 " viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
                <p class="text-center text-gray-800 dark:text-white">© Uccuyo 2021 - All rights reserved</p>
            </div>
